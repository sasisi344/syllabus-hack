...
| プロフェッショナルデジタルスキル試験（`pd-m`/`pd-s`、新設・3区分） | 2027年夏〜秋、新設 | `syllabus-pd-m-2027.json`・`syllabus-pd-s-2027.json`取得・構造化済み | **2026-09-22、両コースとも本文執筆・本番公開完了**。詳細は[`archive/pd-course/pd-course-task.md`](./archive/pd-course/pd-course-task.md)参照 |
