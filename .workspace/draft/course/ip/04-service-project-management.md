...
<!-- island: quizRef=course-ch4。UI仕様はip-course-curriculum.md §3-5参照 -->

1. SLA（サービスレベルアグリーメント）の説明として最も適切なものはどれか。
   - ア: 障害発生時の緊急連絡網
   - イ: サービス提供者と利用者が合意する品質水準を数値で定めた文書
   - ウ: システム開発の契約書の一種
   - エ: サービスデスクの営業時間を示す表
   - **正解**: イ
2. プロジェクトの作業を階層的に分解し、漏れなく洗い出す技法はどれか。
   - ア: ガントチャート
   - イ: アローダイアグラム
   - ウ: WBS（作業分解構造）
   - エ: SLA
   - **正解**: ウ
3. 利用者からの問い合わせを一元的に受け付ける単一窓口の原則を指す用語はどれか。
   - ア: エスカレーション
