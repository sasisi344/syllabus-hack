...
lastmod: 2026-07-11
title: '土木施工管理技士（1級・2級）完全攻略ガイド｜AIで「施工経験記述」を突破するロードマップ'
...
metadata:
  description: '土木施工管理技士（1級・2級）の完全攻略ガイド。第一次検定・第二次検定の違い、受験資格、合格率、必要勉強時間を整理し、生成AIを専任講師にして学習ロードマップを作る方法と、第二次検定最大の難所「施工経験記述」をAIで添削する手順を解説します。'
---

結論：土木施工管理技士は第一次検定（学科）と第二次検定（実地・記述）の2段階構成で、特に第二次検定の<strong>「施工経験記述」</strong>が最大の壁になる。本記事では1級・2級の制度の違いを整理したうえで、生成AIを専任講師として使い、自分の立場に合った学習ロードマップと経験記述の作り方を解説する。
