...
### Day 15〜20: 苦手機能の集中スプリント

模擬試験を1回解いて、正答率が低かった機能をリストアップします。

リストをAIに渡して弱点特化の練習問題を生成してもらいます。

```text
MOS Excel試験の模擬テストで以下の機能を
間違えました。各機能について、
似た問題を2問ずつ出題してください。
その後、私が答えたら採点と解説をしてください。

間違えた機能：
- VLOOKUP と XLOOKUP の使い分け
- テーブル機能の構造化参照
- 印刷設定（ページ設定・ヘッダーフッター）
```

市販の問題集には問題数の上限がありますが、AIは弱点に絞った問題を無限に生成できます。
