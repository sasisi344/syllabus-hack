...
metadata:
  description: '生成AIに自分のデータを学習させない「オプトアウト」の仕組みをITパスポート試験向けに解説。プライバシー保護の考え方、利用規約で確認すべきポイント、試験で問われるAIガバナンスの基礎知識までを一気に整理します。安心して生成AIを使うための第一歩をここから学べます。'
---
...
### AWSでのAIサービス一括オプトアウト（Organizations活用）
